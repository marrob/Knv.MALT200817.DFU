...
namespace Knv.MUDS150628.NiXnet
{
    ...
    internal class NiXnet : object, IDisposable
    {
        ...
        ***********************************************************************/
        ...
        public unsafe int nx_ReadFrame(void* buffer, uint sizeOfBuffer, double timeOut, out uint numberOfBytesReturned)
        {
            int pInvokeResult = PInvoke.nx_readFrame(this._handle, buffer, sizeOfBuffer, timeOut, out numberOfBytesReturned);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        ...
        /*
        public unsafe int nx_ReadFrame(IntPtr buffer, uint sizeOfBuffer, double timeOut, out uint numberOfBytesReturned)
        {
            int pInvokeResult = PInvoke.nx_readFrame(this._handle, buffer, sizeOfBuffer, timeOut, out numberOfBytesReturned);
            PInvoke.TestForError(this._handle, pInvokeResult);
            return pInvokeResult;
        ...
        /*nxStatus_t _NXFUNC nxWriteFrame (
                                   ...
                                   f64 Timeout);/* */
        public unsafe int nx_WriteFrame(void* buffer, uint numberOfBytesForFrames, double timeOut)
        {
        ...
        private class PInvoke
        {
            ...
            [DllImport(niXNETdll, EntryPoint = "nxReadFrame", CallingConvention = CallingConvention.Cdecl)]
            public static unsafe extern int nx_readFrame(System.IntPtr sessionRef, void* Buffer, uint sizeOfBuffer, double timeOut, out uint NumberOfBytesReturned);
            ...
            public static unsafe extern int nx_writeFrame(System.IntPtr sessionRef, void* buffer, uint NumberOfBytesForFrames, double timeOut);
            ...
            *************************************************************************************/
            ...
            public static int ThrowError(System.IntPtr handle, int errorCode)
            {
                ...
                throw new ExternalException(errorMsg.ToString(), errorCode);
            }
